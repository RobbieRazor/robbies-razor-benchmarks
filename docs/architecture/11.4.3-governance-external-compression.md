...
RC-03 provides the framework-level orientation for evaluating how recursive systems operate under declared energetic, informational, governance, economic, operational, and propagation constraints.

RC-13 provides the current Stability Minimum orientation relevant to systems operating under competing preservation, recomputation, resource, and governance demands.
...
RC-19
→ evaluate predictive, comparative, empirical, or performance claims under declared conditions

RC-20
→ evaluate compression or scaling benefits against utility, fidelity, provenance, accessibility, cost, governance burden, distortion, and risk
...
```text
similar governance pressure across domains
≠
shared causal mechanism
```

This repository document may operationalize and evaluate these concepts within a declared scope.
